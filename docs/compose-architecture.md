...
This document describes the relationships and roles of the services defined in the provided `docker-compose.yml` and `docker-compose.override.yml` files, with a focus on what gets overridden.
